...
const CreateUserForm = ({ user }) => {
  ...
  const onSubmit = (data) => {
    ...
    if (user) {
      UserService.updateById(data, user.id).then((res) => {
        Loading.remove();
  ...
  useEffect(() => {
    RoleService.getRoles().then((res) => setRoles(res.data));
  }, []);
  const onChangeButton = () => {
    ...
    if (
      ...
      watchAllFields.gender !== null &&
      watchAllFields.joinedDate !== "" &&
      watchAllFields.lastName !== "" &&
      watchAllFields.roleId !== "" &&
      isEmpty
    ) {
      setDisable(false);
    } else {
  ...
  return (
    <div className="container d-flex justify-content-center align-items-center">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-50">
        <div>
          {user ? (
            <h4 className="text-danger">Edit User</h4>
          ) : (
          ...
          <div className="row g-3 align-items-center mb-2">
            ...
            <div className="col-auto">
              <input
                ...
                type="text"
                {...register("firstName", {
                  validate: { requiredCondition, specialCharCondition },
                })}
            ...
            <div style={{ marginLeft: "124px" }}>
              {errors.firstName &&
                errors.firstName.type === "requiredCondition" && (
                  <div className="text-danger">This is required field</div>
                )}
              {errors.firstName &&
                errors.firstName.type === "specialCharCondition" && (
          ...
          <div className="row g-3 align-items-center mb-2">
            ...
            <div style={{ marginLeft: "124px" }}>
              {errors.lastName &&
                errors.lastName.type === "requiredCondition" && (
                  <div className="text-danger">This is required field</div>
                )}
              {errors.lastName &&
                errors.lastName.type === "specialCharCondition" && (
                  <div className="text-danger">Only accept word</div>
                )}
            </div>
          </div>
            ...
            <div className="col-auto">
              <div style={{ width: "228px" }}>
                <Controller
                  ...
                  name="birth"
                  rules={{
                    validate: { ageCondition, validDateConfidtion },
                    required: true,
                  }}
                  render={({ field }) => (
                    <DatePicker
          ...
          <div className="row g-3 align-items-center mb-2">
            ...
            <div className="col-auto">
              ...
              <div style={{ width: "228px" }}>
                <Controller
                  ...
                  rules={{
                    validate: {
                      joinedDateConditionNotSatAndSun,
                      joinedDateCondition,
                      validDateConfidtion,
                    },
                    required: true,
            ...
            <div style={{ marginLeft: "122px" }}>
              {" "}
              {errors.joinedDate &&
                errors.joinedDate.type === "joinedDateCondition" && (
                  <div className="error text-danger">
                    Joined date is not later than Date of Birth. Please select a
                    different date
                  </div>
                )}
              {errors.joinedDate &&
                errors.joinedDate.type ===
                  "joinedDateConditionNotSatAndSun" && (
                  <div className="error text-danger">
              ...
              {errors.joinedDate &&
                errors.joinedDate.type === "validDateConfidtion" && (
                  <div className="error text-danger">Invalid date</div>
                )}
            </div>
          </div>
          <div className="row g-3 align-items-center mb-2">
            ...
            <div
              className="col-auto"
              style={{ marginLeft: "58px", width: "238px" }}
            >
              <select
                class="form-select"
          ...
          <div className="row g-3 align-items-center mb-2">
            <div>
              <input
                ...
                style={{ border: "solid 1px black", marginLeft: "182px" }}
              ></input>
              <Link to="/manage-user">
                <input
                  type="button"
                  ...
                  style={{ border: "solid 1px black", marginLeft: "32px" }}
                ></input>
              </Link>
            </div>
          </div>
